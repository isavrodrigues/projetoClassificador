...
def print_info(custom_message : str = ""):
    ...
    """
    console.print("Hello! I am projetoClassificador")
    console.print(f"Author: { projetoClassificador.__author__}")
    console.print(f"Version: { projetoClassificador.__version__}")
    if custom_message != "":
...
def run():
    ...
    """
    print("Hello world!")
    projetoClassificador.my_function()
