...
MODULE_SLUG = "projetoClassificador"
...
setup(
    ...
    url="https://github.com/isavrodrigues/projetoClassificador",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'projetoClassificador-cli={MODULE_SLUG}.main:app',
        ],
    },
